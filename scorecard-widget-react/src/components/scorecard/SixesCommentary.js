...
function SixesCommentary({ sixesCommentary }) {
    return (
        <div className="simc-block-content">
            <div className="simc-block-section si-all-comm">
                {
                    (sixesCommentary.length)
                    ?
                    sixesCommentary.map(obj => {
                        let ballClass = "";
                        let ballContent = "";
...
const mapStateToProps = (state) => {
    return {
        sixesCommentary: state.ScorecardReducer.sixesCommentary
    };
};

export default connect(mapStateToProps)(SixesCommentary);